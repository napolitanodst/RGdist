...
# ground truth genes
library(readr)
heme_response_downgenes <- read_csv("../RGDIST/RGDIST 2.0/Control/heme_response_downgenes.csv")
heme_response_upgenes <- read_csv("../RGDIST/RGDIST 2.0/Control/heme_response_upgenes.csv")
